...
Comparing these four models involves fitting five building blocks:
$f(T\vert D)$,
$f(M\vert D)$,
$f(T\vert M)$,
$f(M\vert T)$,
...
Comparing these four models also involves fitting five building blocks:
$f(T\vert D)$,
$f(M\vert C)$,
$f(T\vert M,D^*)$,
$f(M\vert T,C^*)$,
...
2-driver relationship | likelihood ratio
------------ | ----------------
$1^*$: $D\rightarrow T$ | $f(T\vert D)/f(T)$
